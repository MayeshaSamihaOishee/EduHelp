...
public class MatAttendanceFragment extends Fragment {

    ListView listView;
    ArrayAdapter <String> adapter;
    ArrayList <String> arrayList;

    public static final String GET_URL= "http://jachaibd.com/lict_brac/Eduhelp/Attendance_MAT110_getData.php";

    @Override
    public View onCreateView (LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle){
        View v= inflater.inflate(R.layout.activity_mat_attendance_fragment, null);
