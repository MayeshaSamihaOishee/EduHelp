...
public class MatMarks extends AppCompatActivity {

    ListView listView;
    ArrayAdapter<String> adapter;
    ArrayList<String> arrayList;

    public static final String GET_URL= "http://jachaibd.com/lict_brac/Eduhelp/MAT110marks_getData.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mat_marks);

        arrayList=new ArrayList<>();
        listView=findViewById(R.id.list_View_call_history);
        adapter=new ArrayAdapter<String>(MatMarks.this, R.layout.list_view_text_color, arrayList);

        listView.setAdapter(adapter);
        RequestQueue queue = Volley.newRequestQueue(MatMarks.this);
